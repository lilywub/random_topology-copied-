...
def mnist_noniid(dataset, num_users):
    ...
    # 10,000 training imgs -->  100 imgs/shard X 100 shards
    # num_shards, num_imgs = 100, 100
    # 3,000 training imgs -->  60 imgs/shard X 50 shards
    # num_shards, num_imgs = 50, 60
    ...
    print("------------------", len(dataset.targets),labels.shape)
    ...
    for i in range(num_users):
        # assign x shards to each client
