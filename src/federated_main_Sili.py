...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        local_w = w
        print("hahahhahahahahahhahahhahahahha")
        #print(local_w[0]['fc3.bias'])
        for idx in idxs_users:
            # local_w[idx]['fc3.weight'] = global_weights['fc3.weight']
            # local_w[idx]['fc3.bias'] = global_weights['fc3.bias']
            # local_w[idx]['fc2.weight'] = global_weights['fc2.weight']
            # local_w[idx]['fc2.bias'] = global_weights['fc2.bias']
            # local_w[idx]['fc1.weight'] = global_weights['fc1.weight']
            # local_w[idx]['fc1.bias'] = global_weights['fc1.bias']
            # local_w[idx]['conv3.weight'] = global_weights['conv3.weight']
            # local_w[idx]['conv3.bias'] = global_weights['conv3.bias']
            local_w[idx]['conv2.weight'] = global_weights['conv2.weight']
            local_w[idx]['conv2.bias'] = global_weights['conv2.bias']
            # local_w[idx]['conv1.weight'] = global_weights['conv1.weight']
            # local_w[idx]['conv1.bias'] = global_weights['conv1.bias']
    ...
    for idx in range(args.num_users):
        print("oohhohohhhohohohohohhohoh", idx)
        temp_model.load_state_dict(local_w[idx])
    ...
    file_name = '/home/sili/Documents/PhD/Federated-Learning-PyTorch-master/save/objects/{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}].pkl'.\
    ...
    plt.savefig('/home/sili/Documents/PhD/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_loss.png'.
    ...
    plt.xlabel('Communication Rounds')
    plt.savefig('/home/sili/Documents/PhD/Federated-Learning-PyTorch-master/save/fed_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_acc.png'.
                format(args.dataset, args.model, args.epochs, args.frac,
                       args.iid, args.local_ep, args.local_bs))
